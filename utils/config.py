...
from models.general_model_DT import GeneralDecisionTransformer
from models.general_model_transforlight import GeneralTransformerLight
from models.general_TT import GeneralTrajectoryTransformer

DIC_AGENTS = {
    "General": GeneralAgent,
    'General_GeneralDecisionTransformer' : GeneralDecisionTransformer,
    "General_TransformerLight": GeneralTransformerLight,
    "General_TrajectoryTransformer": GeneralTrajectoryTransformer
}
