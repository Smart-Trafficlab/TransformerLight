...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,           default='benchmark_GeneralDecisionTransformer')
    parser.add_argument("-mod",        type=str,           default="General_GeneralDecisionTransformer")
